...
## how to start
### go to this link: https://daveandbustrer.github.io/bluOS/
___
...
### if you want to use any app just click the square on the bottom bar like a normal app in a copmputer
___

## other features
### 1. it has a time feature where it will say the current time
### 2. it has moveable windows if you drag it from the top
